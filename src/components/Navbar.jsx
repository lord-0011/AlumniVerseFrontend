              ...
              {user && user.type === 'alumni' && (
                <Link to="/connections" title="Connections" className="p-2 rounded-full hover:bg-gray-100 relative">
                  ...
                  {connectionRequests > 0 && (
                    <div className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center text-[10px]">
                      {connectionRequests}
                    </div>
                  )}
                </Link>
              ...
              <div className="relative">
                ...
                {isProfileMenuOpen && (
                  ...
                  >
                    ...
                    <Link to="/profile/edit" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" onClick={() => setProfileMenuOpen(false)}>
                      Edit Profile
                    </Link>
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="p-4">
            <form onSubmit={handleSearchSubmit} className="relative">
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full bg-gray-100 border rounded-full py-2 px-4 pl-10"
              />
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="flex items-center px-5">
              <img className="h-10 w-10 rounded-full object-cover" src={avatarSrc} alt="User Avatar" />
              <div className="ml-3">
